    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer p-0 border-0">
                ...
                <div class="col-6 m-0 p-0">
                    <a href="<?php echo e(route('login')); ?>"class="btn btn-success btn-lg btn-block">
...
<?php /**PATH /var/www/resources/views/livewire/site/carrinho/forma_entrega/_nao_logado.blade.php ENDPATH**/ ?>