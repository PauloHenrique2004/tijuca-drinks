...
<div class="card border-0 osahan-accor rounded shadow-sm overflow-hidden mt-3">
    <div class="card-header bg-white border-0 p-0" id="headingthree">
        <h2 class="mb-0">
            <button type="button" data-toggle="collapse" data-target="#collapsethree" aria-expanded="true"
                ...
                <span class="c-number">4</span> Qtd Pessoas
            </button>
        </h2>
    </div>
    <div id="collapsethree" class="collapse show" aria-labelledby="headingthree" data-parent="#accordionExample">
        <div class="card-body p-0 border-top">
            ...
            <?php if( !filled($quantidade_pessoas) || (int)$quantidade_pessoas < 1 ): ?>
...
<?php /**PATH /var/www/resources/views/livewire/site/carrinho/quantidade_pessoas/_quantidade_pessoas.blade.php ENDPATH**/ ?>